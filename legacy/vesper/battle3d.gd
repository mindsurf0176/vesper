...
func _btn_style(b: Button, base: Color) -> void:
	...
	sb.bg_color = Color(base.r * 0.72, base.g * 0.72, base.b * 0.72, 0.96); sb.set_corner_radius_all(0)
	sb.set_border_width_all(2); sb.border_color = base.lightened(0.24)
	sb.shadow_color = Color(0, 0, 0, 0.42); sb.shadow_size = 3; sb.shadow_offset = Vector2(2, 2)
