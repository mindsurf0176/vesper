...
static func table() -> Dictionary:
	...
	return {
		"aries": {
			"name": "Riven", "true_name": "Riven Vale", "gender": "female",
			"epithet": "열선 선봉", "motif": "붕괴 전선을 절개하는 열선 건틀릿과 저자세 돌입",
			"faction": "회랑 돌입반", "personality": "결론보다 첫발이 빠르고 실패를 웃음으로 넘긴다",
			...
			"atk_range": 6.0, "move_speed": 15.0,
			"ability": {"name": "열선 점화", "description": "출격 후 4초간 이동·공격 속도 +35%",
				"deploy_haste": 1.35, "duration": 4.0},
			"flavor": "길이 없으면 가장 먼저 불꽃으로 길을 만든다",
		},
		"sagittarius": {
			"name": "Vigil", "true_name": "Vigil Cross", "gender": "male",
		...
		"virgo": {
			"name": "Mender", "true_name": "Mira Mender", "gender": "female",
		...
		"taurus": {
			"name": "Anchor", "true_name": "Bram Anchor", "gender": "male",
		...
		"capricorn": {
			"name": "Warden", "true_name": "Nera Warden", "gender": "female",
		...
		"gemini": {
			"name": "Mirror", "true_name": "Mirae Voss", "gender": "female",
		...
		"libra": {
			"name": "Gauge", "true_name": "Galen Rook", "gender": "male",
		...
		"aquarius": {
			"name": "Coil", "true_name": "Cira Coil", "gender": "female",
		...
		"cancer": {
			"name": "Shell", "true_name": "Sable Orin", "gender": "female",
		...
		"pisces": {
			"name": "Ripple", "true_name": "Rhea Vale", "gender": "female",
			"epithet": "파문 유격수", "motif": "유체총과 미끄러지는 저자세로 조준선을 흩트리는 정찰 사수",
